...
foreach ystart (1 51 101)

@ yend   = $ystart + 49

@ start_year = ${ystart} + 100
@ end_year   = ${yend}   + 100

set CASE_NAME  = v2.LR.abrupt-4xCO2_0101
set OUT_NAME   = v2.LR.abrupt-4xCO2
...
set RUN_FILE_DIR  = /global/cfs/cdirs/e3sm/zhan391/polar_diag/run_script/model_data_process/v2_LR/archive/atm/hist/
