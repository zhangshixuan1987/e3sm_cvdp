...
#foreach model_case (v2.LR.hist-aer_0251 \
#                    v2.LR.hist-GHG_0251 \
foreach model_case ( v2.LR.hist-all-xGHG-xaer_0251)
...
set var2d_list = ("Z500","U250","TREFHT","TREFHTMN","TREFHTMX","TS","TVQ","TUQ","OMEGA500","CLDTOT","FLNT","FSNT","FLNS","FLUT","FSNS","FLDS","FSDS","LHFLX","SHFLX","QREFHT","OMEGA500","PRECT","PS","UBOT","VBOT","TOZ","TMQ","TGCLDLWP","TGCLDIWP","TGCLDCWP","T250")
...
set SE_FILE =  ${WORK_DIR}/SE/${CASE_NAME}_eam.h1_monthly_${time_tag}.nc
set FV_FILE =  ${WORK_DIR}/${CASE_NAME}_eam.h1_monthly_${time_tag}.nc

rm -rvf $SE_FILE
rm -rvf $FV_FILE
ncrcat -d time,0, -v ${var2d_list} $eam_files ${SE_FILE}
