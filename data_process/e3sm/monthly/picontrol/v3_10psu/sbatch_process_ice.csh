...
set exp_name   = v310PSU.LR.piControl
set model_case = (20240109.v3.LR.piControl.10psu.chrysalis)
set ncase = $#model_case
set rundir = "/lcrc/group/e3sm/ac.abarthel/E3SMv3"
...
#Mapping file
set MAP_FILE  = /lcrc/group/acme/ac.szhang/acme_scratch/data/regrid_maps/map_IcoswISC30E3r4_to_1.0x1.0degree_conserve.nc
...
while ( $i <= $ncase )
 ...
 set iy = $start_year
 set RUN_FILE_DIR = ${rundir}/${CASE_NAME}/run #archive/ice/hist
