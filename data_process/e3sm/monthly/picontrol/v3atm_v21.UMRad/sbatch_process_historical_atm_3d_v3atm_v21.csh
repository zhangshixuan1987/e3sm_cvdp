...
while ( $i <= $ncase )
 ...
 set RUN_FILE_DIR = /lcrc/group/e3sm/ac.wlin/E3SM_simulations/E3SMv3_dev/${CASE_NAME}/archive/atm/hist
#set RUN_FILE_DIR = /lcrc/group/e3sm/ac.wlin/E3SM_simulations/E3SMv3_dev/${CASE_NAME}/run/
