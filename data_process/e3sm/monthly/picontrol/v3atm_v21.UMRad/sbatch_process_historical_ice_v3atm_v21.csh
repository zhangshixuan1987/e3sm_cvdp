...
set exp_name   = v3atm-v21ocn-UMRad.piControl
set model_case = (20230412.v3atm-v21ocn-UMRad.piControl.chrysalis)
...
while ( $i <= $ncase )
 ...
 set iy = $start_year
 set RUN_FILE_DIR0 = /lcrc/group/e3sm/ac.wlin/E3SM_simulations/E3SMv3_dev/${CASE_NAME}/archive/ice/hist
 set RUN_FILE_DIR1 = /lcrc/group/e3sm/ac.wlin/E3SM_simulations/E3SMv3_dev/${CASE_NAME}/run/

 set eam_files = 
 while ($iy <= $end_year)
   set eam_files = ($eam_files $RUN_FILE_DIR0/*mpassi.hist.am.timeSeriesStatsMonthly*`printf "%04d" $iy`* $RUN_FILE_DIR1/*mpassi.hist.am.timeSeriesStatsMonthly*`printf "%04d" $iy`*)
  @ iy ++
 end
