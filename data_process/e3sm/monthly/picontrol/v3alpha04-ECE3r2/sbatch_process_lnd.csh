...
set exp_name   = v3alpha04-ECE3r2.piControl
set model_case = (20231004.v3alpha04_trigrid_ECwISC30to60E3r2.piControl.chrysalis)
...
while ( $i <= $ncase )
 ...
 set iy = $start_year
 set RUN_FILE_DIR = ${rundir}/${CASE_NAME}/run
 echo $RUN_FILE_DIR
