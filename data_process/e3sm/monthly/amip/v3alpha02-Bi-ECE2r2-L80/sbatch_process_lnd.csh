...
set exp_name   = v3alpha02-Bi-ECE2r2-L80.F20TR
set model_case = (20231012.v3alpha02-Bi-ECE2r2-L80.F20TR.F20TR.chrysalis)
...
#Mapping file
set MAP_FILE  = /lcrc/group/acme/ac.szhang/acme_scratch/data/regrid_maps/map_r05_to_cmip6_180x360_nco.20200901.nc
...
while ( $i <= $ncase )
 ...
 set iy = $start_year
 set RUN_FILE_DIR = ${rundir}/${CASE_NAME}/archive/lnd/hist
 set RUN_FILE_DIR = ${rundir}/${CASE_NAME}/run #archive/atm/hist
 echo $RUN_FILE_DIR
