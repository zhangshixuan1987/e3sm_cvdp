...
set rundir = "/lcrc/group/e3sm2/ac.wlin/E3SMv3"

set exp_name   = v3.LR.historical
set model_tag  = ( "0051" "0101" "0151" )
...
set var2d_name = ( "UM10" "LANDFRAC" "OCNFRAC" "ICEFRAC" "PS" "PSL" "LWCF" "SWCF" "PRECC" "PRECL" "AODVIS" "AODDUST" "TGCLDLWP" "CLDLOW" "CLDMED" "CLDHGH" "CLDTOT" "FLNT" "FSNT"  "FLUT" "FLUTC" "TMQ" "TS" "FSNTOA" "FSNTOAC" "FLNS" "FLNSC" "FLDS" "FSNS" "FSNSC" "FSDS" "FSDSC" "SOLIN" "TREFHT" "TREFMNAV" "TREFMXAV" "TAUY" "TAUX" "QFLX" "QREFHT" "PRECSC" "PRECSL" "SCO" "TCO" "O3_SRF" "SHFLX" "LHFLX") 
