...
set model_tag  = ( "0101" "0151" "0201" "0251" "0301" )
set model_ennm = ( "en00" "en01" "en02" "en03" "en04" )
set model_case =
...
while ( $i <= $ncase )
 ...
 echo $CASE_NAME
 #set RUN_FILE_DIR = /lcrc/group/e3sm/ac.golaz/E3SMv2_1/${CASE_NAME}/archive/ice/hist
 #set RUN_FILE_DIR = /lcrc/group/e3sm/ac.xzheng/E3SMv2_1/${CASE_NAME}/archive/ice/hist
 set RUN_FILE_DIR = /lcrc/group/acme/ac.szhang/acme_scratch/data/CVDP_RGD/zstash/v21_ocn/$model_tag[$i]/archive/ice/hist
