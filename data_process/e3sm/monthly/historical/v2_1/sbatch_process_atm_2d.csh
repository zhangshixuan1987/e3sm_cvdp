...
while ( $i <= $ncase )
 ...
 #set RUN_FILE_DIR = /lcrc/group/e3sm/ac.xzheng/E3SMv2_1/${CASE_NAME}/archive/atm/hist
 set RUN_FILE_DIR = /lcrc/group/acme/ac.szhang/acme_scratch/data/CVDP_RGD/zstash/v21_atm/$model_tag[$i]/archive/atm/hist
 #ls $RUN_FILE_DIR
