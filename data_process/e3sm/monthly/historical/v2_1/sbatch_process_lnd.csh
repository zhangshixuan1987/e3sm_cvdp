...
while ( $i <= $ncase )
 ...
 echo $CASE_NAME
 #set RUN_FILE_DIR = /lcrc/group/e3sm/ac.golaz/E3SMv2_1/${CASE_NAME}/archive/lnd/hist
 #set RUN_FILE_DIR = /lcrc/group/e3sm/ac.xzheng/E3SMv2_1/${CASE_NAME}/archive/lnd/hist
 set RUN_FILE_DIR = /lcrc/group/acme/ac.szhang/acme_scratch/data/CVDP_RGD/zstash/v21_lnd/$model_tag[$i]/archive/lnd/hist
