...
setenv OBS_TIME_TAG    "1981-2010" #climatological period for observations
setenv OBS_DATA_ROOT   "/global/cfs/cdirs/e3sm/zhan391/data/ERA5/regrid/${OBS_TIME_TAG}"
...
setenv DOUT_NAME "${TEST_NAME}_vs_${CTRL_NAME}_${OBS_TIME_TAG}"
